...
/**
 * This class adds rewind capability to {@link XmlStringStreamer}
 */
class XmlRewindableStringStreamer extends XmlStringStreamer {
     ...
     */
    public static function createStringWalkerParser( $file, $options = [] ) {
     ...
     * @return XmlStringStreamer        A streamer ready for use
     */
    public static function createUniqueNodeParser( $file, $options = [] ) {
        $stream = new Stream\File($file, 16384);
